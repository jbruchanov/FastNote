...
public class WriteActivityPresenter extends IdeaActivityPresenter implements
    ...
    protected void bind() {
	mContext.getDescriptionRecorderButton().setOnClickListener(
		new OnClickListener() {
		    @Override
	...
	((WriteActivity) getContext()).getDescriptionEditText().setText(
		i.getDescription());
    }
	...
	return StringTools.nullIfTrimmedEmpty(mContext.getDescriptionEditText()
