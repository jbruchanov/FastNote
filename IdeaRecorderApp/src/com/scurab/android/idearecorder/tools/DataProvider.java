...
public class DataProvider extends SQLiteOpenHelper
{
	 ...
	 * @param id for value, if id is null all recorda are returned
	 * @return
	 */
	private List<Idea> getIdeas(Long id)
	{
		...
		if(id == null)
		{
			c = getReadableDatabase().query(Structure.TABLE_IDEAS,
								...
								null, null, null, null, String.format("%s DESC", Structure.Ideas.ID));
		}
		else
		{
			c = getReadableDatabase().query(Structure.TABLE_IDEAS, 
					   ...
					   null, null, String.format("%s DESC",Structure.Ideas.SAVETIME));
		}
		
		while(c.moveToNext())
		{
			Idea i = new Idea();
			i.setDescription(c.getString(c.getColumnIndex(Structure.Ideas.DESCRIPTION)));
	...
	public static class Structure
	{
		...
		public static class Ideas
		{
			...
			public static String[] ALL_COLUMNS = new String[] {ID,TYPE,NAME,DESCRIPTION,PATH,SAVETIME};
		}
	}
