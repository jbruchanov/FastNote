...
public class IOUtils {
    ...
    public static void copyFileFrom(Context c, Uri inputStream, String toFile)
	    throws IOException {
    ...
    public static void copyFile(Context context, Uri uriFrom, String to)
	    throws IOException {
	FileInputStream from = new FileInputStream(getPhysicalLocation(context,
		uriFrom));
	FileOutputStream fos = new FileOutputStream(to);
	byte[] buf = new byte[1024];
	int len;
