 ...
 * 
 */
public class PropertyProvider implements SharedPreferences,
	...
	for (String keyListener : mListeners.keySet()) {
	    OnSharedPreferenceChangeListener prefList = mListeners
		    .get(keyListener);
	...
	int value = this.mResources.getIdentifier(key, namespace, R.class
		.getPackage().getName());
	return value;
    }
