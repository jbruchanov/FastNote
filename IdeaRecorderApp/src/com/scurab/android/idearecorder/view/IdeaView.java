...
public class IdeaView extends LinearLayout {
    ...
    private void init() {
	mContentView = (ViewGroup) inflate(getContext(), R.layout.ideaview,
		null);
	...
	mDescription.setVisibility(StringTools.isNullOrEmpty(mItem
		.getDescription()) ? View.GONE : View.VISIBLE);
