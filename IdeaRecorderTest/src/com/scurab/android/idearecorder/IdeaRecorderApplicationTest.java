...
public class IdeaRecorderApplicationTest extends AndroidTestCase {
	...
	IdeaRecorderApplication c = (IdeaRecorderApplication) getContext()
	...
	IdeaRecorderApplication c = (IdeaRecorderApplication) getContext()
		.getApplicationContext();
	assertTrue(c.getMediaFolder(Environment.DIRECTORY_PICTURES).contains(
		"Android/data/com.scurab.android.idearecorder/files/Pictures"));
    }
