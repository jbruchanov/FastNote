...
public class SpeechActivityPresenterTest extends AndroidTestCase {
    ...
    public void testOpenExisting() throws IllegalStateException, IOException,
	...
	assertEquals(View.GONE,
		msa.getAudioRecordingWidget().findViewById(R.id.btnRecord)
			.getVisibility());
	assertEquals(AudioRecordingWidget.STATE_WAITING_FOR_PLAY_OR_RECORD, msa
		.getAudioRecordingWidget().getState());
    }

    public void testUpdateOk() throws InterruptedException,
