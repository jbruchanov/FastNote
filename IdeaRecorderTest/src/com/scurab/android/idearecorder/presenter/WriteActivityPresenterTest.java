...
public class WriteActivityPresenterTest extends AndroidTestCase
{
	...
	public void testCallingBindedControls()
	{
		...
		mwa.btnDescriptionToText.getOnClickListener().onClick(mwa.btnDescriptionToText);
	...
	public void testCallingNameToText()
	{
		...
		assertEquals(map.reqCode,I.Constants.VOICE_RECOGNITION_REQUEST_CODE_NAME);
	}
	...
	public void testReceiveNameToText()
	{
		...
		map.onActivityResult(I.Constants.VOICE_RECOGNITION_REQUEST_CODE_NAME, Activity.RESULT_OK, i);		
	...
	public void testCallingDescriptionToText()
	{
		...
		assertNotNull(map.startIntent);
		assertEquals(map.reqCode,I.Constants.VOICE_RECOGNITION_REQUEST_CODE_DESCRIPTION);
	}
