...
{
	public static final String FILE = Environment.getExternalStorageDirectory().getAbsolutePath() + "/test.3gpp";
	...
	public void testRecordAndStopState()
	{
		...
		assertTrue(isEnabled(arw,R.id.btnRecord));
		assertEquals(AudioRecordingWidget.STATE_WAITING_FOR_PLAY_OR_RECORD, arw.getState());
	}
	...
	public void testCountingWithTimeResetRecording() throws InterruptedException
	{
		AudioRecordingWidget arw = new AudioRecordingWidget(mContext);
		arw.setAudioRecorder(new MockAudioRecorder());
		arw.startRecording();
...
//	
//	public void testCountingTimePlayingStoppedByEndOfAudio() throws InterruptedException
//	{		
//		AudioRecordingWidget arw = new AudioRecordingWidget(mContext);
